        ...
        <div className='login'>
            ...
            <div className='login__container'>
                ...
                <form>
                    ...
                    <p>By continuing, you agree to Amazon Fake clone of <strong>Vijay Choudhary 🐯</strong> Conditions of Use and Privacy Notice.</p>
                    <button onClick={register} className='login__registereButton'>Create your Amazon Account</button>
                </form>
            </div>
            </div>
